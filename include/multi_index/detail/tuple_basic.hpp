...
struct cons {
  ...
  typename access_traits<
           ...
           >::non_const_type
  get() {
    return multi_index::tuples::get<N>(*this); // delegate to non-member get
  }
...
struct cons<HT, null_type> {
  ...
  typename access_traits<
            ...
            >::non_const_type
  get() {
    return multi_index::tuples::get<N>(*this);
  }
...
struct make_tuple_traits {
  ...
  //  typedef typename IF<
  //  multi_index::is_function<T>::value,
  //  T&,
  //  T>::RET type;
...
inline void swap(cons<HH, TT>& lhs, cons<HH, TT>& rhs) {
  std::swap(lhs.head, rhs.head);
  ::multi_index::tuples::swap(lhs.tail, rhs.tail);
}
template <class T0, class T1, class T2, class T3, class T4,
          class T5, class T6, class T7, class T8, class T9>
inline void swap(tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>& lhs,
  ...
  ::multi_index::tuples::swap(static_cast<base&>(lhs), static_cast<base&>(rhs));
}

} // end of namespace tuples
} // end of namespace multi_index
